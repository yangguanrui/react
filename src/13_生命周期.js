...
/*
  ...
  shouldComponentUpdate 作用就是能在当前渲染发生之前，提前拿到组件即将变化的新值，然后与当前的值（this.props 和 this.state）进行比较，决定是否要执行这次更新。父组件更新时会render子组件也会随之更新，可以判断返回false不更新子组件
  componentWillUpdate 标记为不安全
  render
